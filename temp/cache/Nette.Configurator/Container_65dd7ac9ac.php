<?php
// source: /Applications/MAMP/htdocs/rezervace/sandbox/app/config/config.neon 
// source: /Applications/MAMP/htdocs/rezervace/sandbox/app/config/config.local.neon 

class Container_65dd7ac9ac extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\EmailsPresenter' => array(array('application.1')),
			'App\Presenters\HomepagePresenter' => array(array('application.2')),
			'App\Presenters\PlavbaPresenter' => array(array('application.3')),
		...
		'services' => array(
			'application.1' => 'App\Presenters\EmailsPresenter',
			'application.2' => 'App\Presenters\HomepagePresenter',
			'application.3' => 'App\Presenters\PlavbaPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/Applications/MAMP/htdocs/rezervace/sandbox/app',
			'wwwDir' => '/Applications/MAMP/htdocs/rezervace/sandbox/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/Applications/MAMP/htdocs/rezervace/sandbox/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/Applications/MAMP/htdocs/rezervace/sandbox/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/Applications/MAMP/htdocs/rezervace/sandbox/app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=rezervace', 'root', 'root', array('lazy' => TRUE));
	...
	{
		return new Container_65dd7ac9ac_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/Applications/MAMP/htdocs/rezervace/sandbox/app/../temp/cache/latte');
...
final class Container_65dd7ac9ac_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{

	private $container;


	public function __construct(Container_65dd7ac9ac $container)
	{
