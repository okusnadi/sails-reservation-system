<?php
// source: /Applications/MAMP/htdocs/rezervace/sandbox/app/frontEndModule/presenters/templates/Plavba/rezervovat.latte

class Templateac1f9c504bff16f53094f106041e7afd extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('35c9a9c1cf', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb676e4974bd_content')) { function _lb676e4974bd_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb799e20553d_title')) { function _lb799e20553d_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
