<?php
// source: /www/plavbyolomouc.cz/rezervace.plavbyolomouc.cz/app/frontEndModule/presenters/templates/Plavba/casy.latte

class Template46e3775b2702c22c5660adc6c9dc201c extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7a9a02a9a3', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb795eb04b7e_content')) { function _lb795eb04b7e_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbd743c05c82_title')) { function _lbd743c05c82_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
