<?php
// source: /www/jvitasek.cz/test.jvitasek.cz/app/frontEndModule/presenters/templates/Homepage/default.latte

class Templatebca0d581131d67b50dd99d4717d7cb98 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('342778ff01', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb4fbaacb235_content')) { function _lb4fbaacb235_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="row">
		<div class="col-md-6">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbf1a4f2fca2_title')) { function _lbf1a4f2fca2_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>			<h3>Výběr plavby</h3>
<?php
}}
