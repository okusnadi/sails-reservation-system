<?php
// source: /www/plavbyolomouc.cz/rezervace.plavbyolomouc.cz/app/frontEndModule/presenters/templates/Homepage/default.latte

class Template17ce83c29ba73abb96883a3de859797c extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('59ff41810b', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbcea1722ece_content')) { function _lbcea1722ece_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="row">
		<div class="col-md-6">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbf81aed74c9_title')) { function _lbf81aed74c9_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>			<h3>Výběr plavby</h3>
<?php
}}
