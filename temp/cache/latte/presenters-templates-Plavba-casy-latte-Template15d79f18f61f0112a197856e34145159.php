<?php
// source: /Applications/MAMP/htdocs/rezervace/sandbox/app/frontEndModule/presenters/templates/Plavba/casy.latte

class Template15d79f18f61f0112a197856e34145159 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b239da844b', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb267e52d1b4_content')) { function _lb267e52d1b4_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb9fb59ad8f6_title')) { function _lb9fb59ad8f6_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
