<?php
// source: /www/jvitasek.cz/test.jvitasek.cz/app/frontEndModule/presenters/templates/Plavba/rezervovat.latte

class Templateb92b27b375b996b747e1194e5f7dd256 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('19c0906720', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbf608ca1e2d_content')) { function _lbf608ca1e2d_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb4082324988_title')) { function _lb4082324988_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
