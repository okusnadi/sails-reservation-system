<?php
// source: /Applications/MAMP/htdocs/rezervace/sandbox/app/frontEndModule/presenters/templates/@layout.latte

class Template08576ef8c3a2a181d2b656ac841670d1 extends Latte\Template {
function render() {
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbd7828afeac_head')) { function _lbd7828afeac_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbd09266ade9_scripts')) { function _lbd09266ade9_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
